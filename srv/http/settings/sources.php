<heading class="noline">Devices<i id="addnas" class="fa fa-plus-circle"></i>&emsp;<i id="refreshing" class="fa fa-network blink hide"></i></heading>
...
<heading id="mount" class="status">Mounts<i class="fa fa-code"></i></heading>
<span class="help-block hide"><code>mount | grep ' / \|MPD'</code></span>
<pre id="codemount" class="hide"></pre>

<?php /*<heading class="noline">Network Shares<i id="refreshshares" class="fa fa-refresh hide"></i></heading>
...
<heading id="fstab" class="status">File System Table<i class="fa fa-code"></i></heading>
